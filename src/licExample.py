#https://github.com/matplotlib/basemap/blob/master/examples/lic_demo.py
...
try:
    ...
    #import scikits.vectorplot as vp
except ImportError:
...
ncfile = NetCDFFile('~/Downloads/AL182005_0924_1030.nc')
...
image = vp.lic_internal.line_integral_convolution(udat.astype(np.float32),\
