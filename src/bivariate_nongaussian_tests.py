...
def displayImage(e,q,gmm):
    ...
    pic0 = axarr[0].imshow(e,cmap=cm.gist_heat)
    pic1 = axarr[1].imshow(q,cmap=cm.gist_heat)
    pic2 = axarr[2].imshow(gmm,cmap=cm.gist_heat)
...
def loadImage():
    ...
    return e_out,q_out,gmm_out

def main():
    e, q, gmm = loadImage()
    displayImage(e,q,gmm)
