...
'''
http://www.krioma.net/wp/blog/2011/12/multiple-gaussian-fitting-in-python.php
'''

#generate some data
gaussian = lambda x: 3*exp(-(10-x)**2/10.) + 1*exp(-(15-x)**2/10.)#change the parameters as you see fit
